...
// cannot see.
//
// The screen is widened to 240 columns because the hint is now generated
...
// the end. Phase 6b's New File and Save As bindings pushed the full hint
// to 224 runes, past the 200 columns this test used to widen to — 240 is
// the width Vincent actually runs at — it gets a monitor of its own — and
// it is the narrowest width at which "every binding reached the bar" is a
// claim the bar can satisfy today.
