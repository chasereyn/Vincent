...
```sh
brew tap cloudmanic/spice-edit https://github.com/chasereyn/vincent
...
latest [GitHub Release](https://github.com/chasereyn/vincent/releases),
...
attached to every [GitHub Release](https://github.com/chasereyn/vincent/releases).
...
```sh
git clone https://github.com/chasereyn/vincent.git
cd spice-edit
